    ...
    if (Param.id) {
        $.ajax({
          ...
          success: function(res) {
            ...
            var newsContent = '<div class="panel panel-primary"><div class="panel-heading">'+res.title+'</div><div class="datetimeTitle">日期：'+new Date(parseInt(res.updatetime)).format("yyyy-MM-dd")+'</div><div class="panel-body">'+res.content+'</div></div>';
